  ...
  const projects = [
    {
      ...
      indexBadge: 'WORK 01',
      statusBadge: 'ONGOING CLIENT ENGAGEMENT',
      clientRegion: 'International Client',
      budgetQuotation: '₹2,00,000 Contract Scope',
      category: 'Ongoing Client Project • Member Web Platform',
      eyebrow: 'Work 01 • Ongoing International Client Engagement',
      title: 'CHARITY GOLF CLUB & COMPETITION PLATFORM',
      liveUrl: 'https://golfcharitysubscriptionplatform.vercel.app/', // Live external URL
      statement: 'A custom-engineered web application and member portal in active development for an international client, featuring recurring subscription billing, verified score submission pipelines, automated charity revenue splits, and dynamic prize pool calculations.',
      image: './assets/images/gcp.png',
      overview: 'Charity Golf Club is a custom-engineered web platform and member portal currently in active development for an overseas client. The platform connects golfers with registered non-profit charities, managing recurring membership subscription billing, private member dashboard workflows, verified score submissions, and automated prize allocation.',
      challenge: 'The client required a fraud-resistant, scalable web platform to handle multi-tier member subscriptions, scorecard verification pipelines, automated revenue splits across multiple charitable partners, and central administrative controls.',
      approach: 'We engineered a responsive full-stack web application featuring automated recurring payment processing, dedicated member account areas, structured scorecard verification rules, and an automated prize calculation engine.',
      solution: 'A complete custom digital platform combining automated subscription billing, multi-charity allocation logic, scorecard review queues, role-based administrative auditing tools, and structured member engagement workflows.',
      keyFeatures: [
        'Recurring Member Subscription Billing (Monthly & Annual Plans)',
        'User Account & Private Member Dashboard',
        'Verified Scorecard Submission & Review Workflow',
        'Automated Multi-Charity Revenue Split & Allocation Engine',
        'Dynamic Prize Pool & Tiered Jackpot Calculation Rules',
        'Role-Based Administrative Audit & Verification Portal',
        'Charity Partner Showcase & Direct Impact Showcase',
        'Responsive Mobile-First Architecture & Secure Member Area'
      ],
      outcomes: 'Active client engagement: Core membership system, subscription workflows, user dashboard, and automated allocation rules deployed to live staging for milestone delivery.',
      featured: true,
      published: true,
    },
